...
from network_utils import deform_tripple_3d, flip_tripple_3d

deform = partial(deform_tripple_3d, sigma=5, scale=5)
...
transform = Compose([deform, flip])

dataset = MedicalImageCropSegDataset3d('data')
t_dataset = TransformedMedicalImageDataset3d(dataset, transform)
