...
image_paths = sorted(glob('data/*image.nii.gz'))[:5]
label_paths = sorted(glob('data/*label.nii.gz'))[:5]
mask_paths = sorted(glob('data/*mask.nii.gz'))[:5]

t_dataset, v_dataset = Dataset3dFactory.create(data_factory, (2,3),
